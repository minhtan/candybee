...
Ngày nay, công nghệ càng phát triển, xã hội công nghiệp hóa, các sản phẩm từ tự nhiên đã dần mất đi bản chất vốn có của nó. Nhận thức được điều trên, Candybee đã ra đời với mong muốn mang đến cho người tiêu dùng các sản phẩm từ ong tự nhiên, nguyên chất, đảm bảo về chất lượng và ít có sự can thiệp của con người nhất.
					...
					<div class="row">
						<article class="col-4">
							...
							<p>
								Sản phẩm Candybee có xuất xứ từ Đắc Lắc, nơi có khí hậu nóng ẩm quanh năm, các loài hóa phát triển, tạo nguồn thức ăn dồi dào cho đàn ong
							</p>
						</article>
						<article class="col-4">
							<header class="text-center">
				...
				<section class="bee-content" id="benefit">
					...
					<div class="row benefit-content">
						<article class="text-center col-4 row">
							...
							<p class="lips col-6">
								Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste, vel, eos? Modi porro, facilis tempora.
							</p>
						</article>
						<article class="text-center col-4 row">
							<h3>Chữa bệnh</h3>
						...
						<article class="text-center col-4 row">
							...
							<p class="food col-6">
								Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nulla, quas dicta officiis nisi aspernatur magnam inventore. Suscipit autem, non magnam.
							</p>
						</article>
